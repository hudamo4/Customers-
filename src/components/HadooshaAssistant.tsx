  ...
  const handleSendMessage = async (textToSend: string) => {
    ...
    try {
      ...
      if (normalizedText.includes('تتبع') || normalizedText.includes('شحنتي') || normalizedText.includes('شحنه') || normalizedText.includes('وين الطرد')) {
        ...
        reply = `عزيزتي الكريمة ${profile?.name || ''} ✨، أهلاً بكِ في عالم الأناقة والجمال اللوجستي العراقي Luminous Heritage.\n\nأنا هنا كـ "هدوشة" المساعدة الذكية الأنيقة لأجيب عن كافة استفساراتكِ بخصوص أسعار الشحن ومسارات الطرود وتفاصيل فواتيركِ.\n\nيمكنكِ كتابة أي سؤال مثل: "أين شحنتي؟" أو "كم تكلفة 2 كغم من الكويت؟" وسأجيبكِ فوراً بكل حب ودلال! 🌸💕`;
      }
